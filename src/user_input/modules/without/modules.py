...
from modules.without.sparsemax_no import *
# from modules.densenet import *

# Implements a simple feedforward neural network with configurable layers, used as a building block
# Applies a sequence of linear transformations and ReLU activations, ending with a final linear layer
...
# Implements multiple ProjectionHead instances, allowing for parallel projections to multiple output sizes
...
# Dynamically generates weights for another network (hence "hypernetwork")
...
# A template for processing input using dynamically generated weights
...
# primary model that orchestrates the computations using JointNetTemplate and Gaussian mixture distributions

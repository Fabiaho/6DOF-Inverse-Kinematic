...
def train(cfg):
    ...
    train_dataset = IKDatasetCSV(cfg.train_data_path)
    test_dataset = IKDatasetValCSV(cfg.test_data_path)
...
# lowered early stopping to 30 (from 50)
    parser.add_argument('--lr', type=float, default=0.001, help='learning rate')
    parser.add_argument('--num-epochs', type=int, default=200, help='learning rate')
